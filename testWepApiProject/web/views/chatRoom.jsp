...
<body>
	...
	<div id="chatbox">
		<fieldset>
				...
				<button type="button" id="endBtn">나가긔</button>
		</fieldset>
	</div>
	<script>
	// 사용자 ID 등록
	...
	// 채팅 서버
	var webSocket = new WebSocket('ws://192.168.20.50:8088' + "<%=request.getContextPath()%>/multicast/<%=room%>");
